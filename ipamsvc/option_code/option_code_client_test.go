	...
	testCases := []struct {
	...
	}{
		{
			...
			http.Request{
				...
				Body:   io.NopCloser(strings.NewReader("{\"code\":null,\"name\":null,\"option_space\":null,\"type\":null}\n")),
			},
		},
		{
			"OptionCodeDelete",
		...
		},
		{
			...
			http.Request{
				...
				Body:   io.NopCloser(strings.NewReader("{\"code\":null,\"comment\":\"Updated comment\",\"name\":null,\"option_space\":null,\"type\":null}\n")),
			},
		},
	}
