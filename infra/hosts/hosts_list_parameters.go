...
// WithDefaults hydrates default values in the hosts list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsListParams) WithDefaults() *HostsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsListParams) SetDefaults() {
...
// WithFields adds the fields to the hosts list params
func (o *HostsListParams) WithFields(fields *string) *HostsListParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the hosts list params
func (o *HostsListParams) SetFields(fields *string) {
	o.Fields = fields
}

// WithFilter adds the filter to the hosts list params
func (o *HostsListParams) WithFilter(filter *string) *HostsListParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the hosts list params
func (o *HostsListParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithLimit adds the limit to the hosts list params
func (o *HostsListParams) WithLimit(limit *int64) *HostsListParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the hosts list params
func (o *HostsListParams) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOffset adds the offset to the hosts list params
func (o *HostsListParams) WithOffset(offset *int64) *HostsListParams {
	o.SetOffset(offset)
	return o
}

// SetOffset adds the offset to the hosts list params
func (o *HostsListParams) SetOffset(offset *int64) {
	o.Offset = offset
}

// WithOrderBy adds the orderBy to the hosts list params
func (o *HostsListParams) WithOrderBy(orderBy *string) *HostsListParams {
	o.SetOrderBy(orderBy)
	return o
}

// SetOrderBy adds the orderBy to the hosts list params
func (o *HostsListParams) SetOrderBy(orderBy *string) {
	o.OrderBy = orderBy
}

// WithPageToken adds the pageToken to the hosts list params
func (o *HostsListParams) WithPageToken(pageToken *string) *HostsListParams {
	o.SetPageToken(pageToken)
	return o
}

// SetPageToken adds the pageToken to the hosts list params
func (o *HostsListParams) SetPageToken(pageToken *string) {
	o.PageToken = pageToken
}

// WithTfilter adds the tfilter to the hosts list params
func (o *HostsListParams) WithTfilter(tfilter *string) *HostsListParams {
	o.SetTfilter(tfilter)
	return o
}

// SetTfilter adds the tfilter to the hosts list params
func (o *HostsListParams) SetTfilter(tfilter *string) {
	o.Tfilter = tfilter
}

// WithTorderBy adds the torderBy to the hosts list params
func (o *HostsListParams) WithTorderBy(torderBy *string) *HostsListParams {
	o.SetTorderBy(torderBy)
	return o
}

// SetTorderBy adds the torderBy to the hosts list params
func (o *HostsListParams) SetTorderBy(torderBy *string) {
	o.TorderBy = torderBy
}
